...
mytable <- DT::datatable(events, 
  ...
  DT::formatStyle('state', backgroundColor = styleEqual(c("TX", "NY"),c('blue','purple'))) %>% 
  DT::formatStyle("event_type", backgroundColor = styleEqual(c("rally", "tour"),c("red","orange")))
